            ...
            <div class="card">
                ...
                <div class="card-body">
                    @foreach($result as $res)
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">Задолженность по оплате</label>
                            <div class="col-md-6">
                        ...
                        @if((Auth::user()->type=="admin" or Auth::user()->type=="Facultys") and $res->student_status=="Ожидание")
                        <form action="declaimstudent" method="POST">
                            <div class="card-body">
                                {{csrf_field()}}
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <input name='idob' id='idob' type='hidden' value="{{$res->student_id}}">
                                        <input size="50" class ="btn btn-danger"  value="Отказать в регистрации" type="submit">
                                    </div>
                                </div>
                            </div>
                        </form>
                        <form action="acceptStudent" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <input name='idob' id='idob' type='hidden' value="{{$res->student_id}}">
                                        <input size="50" class ="btn btn-success"  value="Одобрить регистрацию" type="submit">
                                    </div>
                                </div>
                            </div>
                        </form>
